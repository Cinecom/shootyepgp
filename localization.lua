...
L:RegisterTranslations("enUS", function() return {
  --["Term"] = true, -- Example
  -- common
  ["Click $MS or $MSOS or $OS for %s"] = true,
  ["or $MSOS"] = true,
  ["Refresh"] = true,
  ["Refresh window"] = true,
  ["Clear"] = true,
...
Results will print here when done.]],
  ...
  ["|cff0066ff|Hshootybid:1:$ML|h[MAINSPEC]|h|r"] = true,
  ["|cff3ade2f|Hshootybid:2:$ML|h[OFFSPEC]|h|r"] = true,
  ["|cff3ade2f|Hshootybid:3:$ML|h[|r|cffff0000PRIO|r |cff3ade2fOFFSPEC]|h|r"] = true,
  ["Bids"] = true,
  ...
  ["Whisper %s a '+' for MS / '-' for OS / 'OSPRIO' for full price OS with prio for the item: %s"] = true,
  ["Whisper %s a - for %s (offspec)"] = true,
  ["Whisper %s a + or - for %s (mainspec or offspec)"] = true,
  ["Click $MS or $PRIOOS or $OS for %s"] = true,
  ["or $OS "] = true,
  ["$MS or "] = true,
...
完成后打印结果.]],
  ...
  ["5.Tower of Karazhan"] = "5.Tower of Karazhan",
  ["4.Naxxramas"] = "4.纳克萨玛斯",
